...
// 15-45, 45-90...). Barra por tramo, clicable si tiene bugs.
export default function DayRangeDistributionChart({ ranges, color }) {
  return (
    <ResponsiveContainer width="100%" height={170}>
      <BarChart data={ranges} margin={{ top: 16, right: 4, left: 4, bottom: 0 }}>
        ...
        >
          {ranges.map((r) => (
            <Cell key={r.label} fill={color} opacity={r.count === 0 ? 0.25 : 1} />
          ))}
